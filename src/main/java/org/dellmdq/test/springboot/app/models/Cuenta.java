...
@Entity
@Table(name="cuentas")//esto es opcional, por defecto hibernate define el nombre de la tabla igual al de la clase
public class Cuenta {
    @Id
    ...
    /**Enviamos dinero a otra cuenta. Se resta del saldo de la nuestra*/
